...
<body>
   ...
   <!-- #region-->
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="client-profile.html"><i class="fas fa-user"></i> Profile</a></li>
            ...
            <li><a href="blog.html"><i class="fas fa-book"></i> Read Blogs</a></li>
    ...
    <div class="content">
         <!-- Image Container -->
    <div  class="heroContainer"> <img src="images/new14.jpg" alt="" class="heroImage"></div>
       ...
       <h1>Welcome to Soothify, <?php echo htmlspecialchars($name); ?>!</h1>
        ...
        <div class="text-box">  
            ...
            <div class="buttonContainer"><a href="get-started.html" class="hero-btn">Get started</a></div>
        </div>
       </div>
    </div>
</body>
